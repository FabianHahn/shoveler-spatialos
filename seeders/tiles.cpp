...
int main(int argc, char **argv) {
	...
	for(List<ChunkData>::const_iterator iter = chunks.begin(); iter != chunks.end(); ++iter) {
		...
		chunkBackgroundEntity.Add<Sprite>({nextEntityId, CoordinateMapping::POSITIVE_X, CoordinateMapping::POSITIVE_Y, canvasEntityId, 0, {(float) chunkSize, (float) chunkSize}, {}, {nextEntityId}});
		...
		chunkForegroundEntity.Add<Sprite>({nextEntityId, CoordinateMapping::POSITIVE_X, CoordinateMapping::POSITIVE_Y, canvasEntityId, 2, {(float) chunkSize, (float) chunkSize}, {}, {nextEntityId}});
